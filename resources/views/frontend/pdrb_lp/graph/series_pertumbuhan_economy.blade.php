    ...
    <div class="card col-md-12 col-12">
        <div class="card-header">
            <div class="card-head-row card-tools-still-right">
                <h4 class="card-title">Pertumbuhan Ekonomi</h4>
            ...
            <p class="card-category"> Pertumbuhan Ekonomi Tahun 2015-2019</p>
        </div>
        <div class="card-body">
...
<script>
    var gk_data=@json($series_pertumbuhan_ekonomi,JSON_PRETTY_PRINT);
