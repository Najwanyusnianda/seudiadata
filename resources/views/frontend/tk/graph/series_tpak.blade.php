    ...
    <div class="card col-md-12 col-12">
        <div class="card-header">
            <div class="card-head-row card-tools-still-right">
                <h4 class="card-title">Tingkat Pengangguran Angkatan Kerja</h4>
            ...
            <p class="card-category"> Perkembangan Tingkat Pengangguran Akngkatan Kerja di Aceh Barat Daya tahun 2010-2019</p>
        </div>
        <div class="card-body">
...
<script>
    var gk_data=@json($series_tpak,JSON_PRETTY_PRINT);
