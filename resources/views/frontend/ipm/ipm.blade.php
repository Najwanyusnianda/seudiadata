...
<div class="card p-3">
    <ul class="nav nav-pills nav-primary">
        <li class="nav-item">
          <a class="nav-link" href="{{route('ipm.graph')}}" id="ipmGrafik">Grafik</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{route('ipm.map')}}" id="ipmPeta">Peta</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="{{route('ipm.data')}}"  id="ipmData">Data</a>
        </li>
     </ul> 
</div>
...
<script >
    ...
    $(document).ready(function(){
        ...
        var wrapper= $('.ipm-wrapper');
        var ulasan =$('#ipmUlasan');
        var peta=$('#ipmPeta');
        var grafik=$('#ipmGrafik');
